...
print('Please move your mouse to the top left corner of any square item icon INCLUDING THE GREY BORDER')
printI('then press `x`')
...
print('WARNING: DO THIS NEXT INSTRUCTION CAREFULLY')
print('Please move your mouse to the bottom right corner of any square item icon INCLUDING THE GREY BORDER')
printI('then press `x`')
